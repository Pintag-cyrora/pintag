...
DROP POLICY IF EXISTS "Staff full access contacts" ON contacts;
...
DROP POLICY IF EXISTS "Authenticated read own-scope contacts" ON contacts;
...
DROP POLICY IF EXISTS "Party insert own contact" ON contacts;
...
DROP POLICY IF EXISTS "Party update own contact" ON contacts;
