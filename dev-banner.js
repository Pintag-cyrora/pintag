...
// always has ground truth on screen. Pure UI; no environment-detection
// logic lives here (see config.js). Must load after config.js.
(function () {
  if (!window.PINTAG || window.PINTAG.isProduction) return;

  document.addEventListener('DOMContentLoaded', function () {
    var banner = document.createElement('div');
    banner.textContent = '⚠ DEVELOPMENT ENVIRONMENT — pintag-dev database, not production';
