...
// tests/intelligence/static-server.js exactly, just a different port so
// both suites can run concurrently without colliding.
const http = require('http');
const fs = require('fs');
const path = require('path');

const ROOT = path.join(__dirname, '..', '..');
const PORT = process.env.PW_STATIC_PORT || 8935;
